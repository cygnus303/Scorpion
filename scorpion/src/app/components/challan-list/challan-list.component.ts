...
export class ChallanListComponent {
  ...
  getPANnumberData(event: any) {
    ...
    if (this.challanService.challanForm.value.vendorType === '04' || this.challanService.challanForm.value.vendorType === '19' || this.challanService.challanForm.value.vendorType === 'XX1') {
  ...
  isFieldReadonly(): boolean {
    return (this.challanService.filterList?.DRSType === 'Y' && !!this.challanService.challanForm?.value?.deliveryAgent && this.challanService.isAgentSelected);
  }
