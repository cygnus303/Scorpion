...
export class LrScanningTabComponent {
  ...
  public summaries: ScanSummary[] = [
    { icon: '📝', count: 1, label: 'PRS INSCAN', colorType: 'blue' },
    { icon: '📋', count: 3, label: 'LS OUTSCAN', colorType: 'purple' },
    { icon: '🚛', count: 3, label: 'THC INSCAN', colorType: 'orange' },
    { icon: '🛵', count: 1, label: 'DRS OUTSCAN', colorType: 'green' },
    { icon: '✅', count: 1, label: 'DELIVERY', colorType: 'gold' }
  ];

  public timeline: ScanEvent[] = [
    // ... timeline array remains the same
    {
      theme: 'blue',
      icon: '📝',
      badge: 'IN',
