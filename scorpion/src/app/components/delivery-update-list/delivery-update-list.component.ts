...
@Component({
  ...
  providers: [DeliveryUpdateService, BsModalService]
})
export class DeliveryUpdateListComponent {
  ...
  constructor(public challanService: ChallanService, public deliveryUpdateService: DeliveryUpdateService,
    ...
    public docketService: DocketService, private THCService: THCMasterService, public generalMasterService: GeneralMasterService,
