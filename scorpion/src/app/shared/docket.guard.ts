...
export class DocketGuard implements CanActivate {
  ...
  canActivate(route: ActivatedRouteSnapshot): boolean {
    ...
    try {
      ...
      else if (currentRoute.includes("docketEditCretria") || currentRoute.includes("docket") || currentRoute.includes("delivery-agent") || currentRoute.includes("ScanFMDocuments") || currentRoute.includes("PFM")|| currentRoute.includes("MenuAccess")) {
