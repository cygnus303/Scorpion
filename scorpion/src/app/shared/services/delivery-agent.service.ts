...
export class DeliveryAgentService {
  ...
  getVendors(location:string,vendorType:string): Observable<any> {
    return this.apiHandlerService.Get(`External/GetVendors?Location=${location}&VendorType=${vendorType}`);
  }
