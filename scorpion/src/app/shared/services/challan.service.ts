...
onSubmit(){
  ...
  const payload = {
    ...
    THCSF:"0",
    THCDate:new Date(challanForm?.tHCDate)?.toISOString(),
    ...
    ActualDeptDate:new Date(challanForm?.actualDeptDate)?.toISOString(),
    ScheduleDeptDate:new Date(challanForm?.scheduleDeptDate)?.toISOString(),
    LateEarly:"",
    ScheduleNo:"",
    ScheduleTime:"",
    ...
    LoadingDate:new Date(challanForm?.loadingDate)?.toISOString(),
    CityRouteCode:"",
    CityRouteKM:"",
    ...
    "CTFD":{
      ...
      LoadedRateType:"",
      LoadedBy:this.filterList?.loadingByName ? this.filterList?.loadingByName:'',
